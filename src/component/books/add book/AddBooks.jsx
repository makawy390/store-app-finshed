...
setImage(e.target.files[0])
  ...
  <input type='file' style={{display :'none'}} onChange={onChangeImage} ref={inputRef}  />
    ...
    <TextField fullWidth placeholder="nam a product" id="fullWidth" name='title'
     sx={{margin : '10px 0'}} onChange={handelChange} />
    <TextField fullWidth placeholder="description" id="fullWidth" sx={{margin : '10px 0'}} name='description'
     onChange={handelChange}  />
    {/* <TextField fullWidth placeholder="link" id="fullWidth" name='link'
      sx={{margin : '10px 0'}} onChange={handelChange}  />
     */}
          <OutlinedInput fullWidth
            id="standard-adornment-amount" placeholder='price' name='price' onChange={handelChange}
